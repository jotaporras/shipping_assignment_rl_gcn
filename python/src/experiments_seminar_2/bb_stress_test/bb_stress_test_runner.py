...
def setup_argparser():
    ...
    parser.add_argument("--num_commodities", type=int, default=15)
    parser.add_argument("--orders_per_day", type=int, default=3)
    parser.add_argument("--dcs_per_customer", type=int, default=3)
...
if __name__ == "__main__":
    ...
    print(f"Parsed args: {json.dumps(args_dict, sort_keys=False, indent=4)}")
    ...
    experiment_name = (
        ...
        else f"{codename}_bb_stress_test_fixed_V"
    )
