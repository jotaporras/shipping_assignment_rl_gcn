...
if __name__ == "__main__":
    """
    Q Learning with simple Big M reward, one commodity.
    """
    config_dict = {
        "env": {
            "num_dcs": 3,
            ...
            "reward_function": "simple_big_m",  # big_m_diff
        },
        "hps": {
    ...
    trainer, model = ptl_wandb_run_builder.create_ptl_shipping_allocation_rl_runner(
        ...
        # experiment_name="should not be visible",
