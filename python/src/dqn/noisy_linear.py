# Code reproduced from https://github.com/PacktPublishing/Deep-Reinforcement-Learning-Hands-On-Second-Edition/blob/master/Chapter08/lib/dqn_extra.py
import math
...
class NoisyLinear(nn.Linear):
    ...
    From Noisy Networks for Exploration ([4] Fortunato and others, 2017)
    """
